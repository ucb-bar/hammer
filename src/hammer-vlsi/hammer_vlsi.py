...
class HammerSynthesisTool(HammerTool):
    ...
    def output_sdc(self) -> str:
        """
        Output SDC file generated by the synthesis tool.
        Optional as not all synthesis tools will produce an output SDC file.

        :return: The output SDC file.
        """
        try:
            return self._output_sdc
        except AttributeError:
            raise ValueError("Nothing set for the output SDC yet")
