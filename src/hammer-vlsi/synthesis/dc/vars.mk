...
OBJ_SYN_MAPPED_SDC = $(OBJ_SYN_DIR)/generated/$(SYN_TOP).mapped.sdc
OBJ_SYN_SIM_FILES = $(OBJ_MAP_SIM_FILES) $(TECHNOLOGY_VERILOG_SIMULATION_FILES) $(OBJ_SYN_DIR)/generated/$(SYN_TOP).force_regs.ucli $(OBJ_SYN_DIR)/generated/$(SYN_TOP).force_regs.tab
