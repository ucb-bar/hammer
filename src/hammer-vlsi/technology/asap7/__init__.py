...
class ASAP7Tech(HammerTechnology):
    ...
    def post_install_script(self) -> None:
        try:
            ...
            try:
                ...
                sys.exit()
        print("DEBUG: cache_dir is at :",self.cache_dir)
    ...
    def generate_multi_vt_gds(self) -> None:
        ...
        TODO:The asap7 std cell lib version 28 comes with RVT, SLVT, SRAM VT GDS files. This step might be redundant.
        """
        try:
        ...
        try:
            ...
            orig_gds = os.path.join(stdcell_dir, "GDS/asap7sc7p5t_28_R_220121a.gds")
    ...
    def fix_icg_libs(self) -> None:
        ...
        TODO:The asap7 std cell lib version 28 fixs icg lib. This step might be redundant.
        """
        ...
        try:
            ...
            for olib, nlib in zip(old_libs, new_libs):
                ...
                subprocess.call(["gzip -cd {olib} | gzip > {nlib}".format(olib=olib, nlib=nlib)], shell=True)
        except:
