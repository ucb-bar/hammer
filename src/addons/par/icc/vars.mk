...
OBJ_PAR_SIM_FILES = $(OBJ_SYN_SIM_FILES) $(TECHNOLOGY_VERILOG_SIMULATION_FILES) $(OBJ_PAR_DIR)/generated/$(PAR_TOP).force_regs.ucli $(OBJ_PAR_DIR)/generated/$(PAR_TOP).force_regs.tab
