...
class HammerDatabase:
    ...
    def get_setting(self, key: str, nullvalue: Any = None, check_type: bool = True) -> Any:
        ...
        """
        # TODO this uses cwd instead of __file__. Certainly this is wrong
        ...
        # TODO Why are we checking defaults everytime we get_setting?.
        #      Retrieved defaults is wrong too...
        #if key not in IGNORE and key not in defaults:
        #    warn(f"Key {key} does not have a default implementation")
        # TODO This issues every single time we call get_setting.
        #      Additionally, lots of things don't have types. Not a user issue.
