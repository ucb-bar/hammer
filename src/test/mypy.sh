...
if [ -f ../../../hammer-cadence-plugins/synthesis/genus/__init__.py ]; then
    MYPYPATH=$MYPYPATH:../../../hammer-cadence-plugins/tool call_mypy ../../../hammer-cadence-plugins/synthesis/genus/__init__.py
fi
...
if [ -f ../../../hammer-cadence-plugins/par/innovus/__init__.py ]; then
    MYPYPATH=$MYPYPATH:../../../hammer-cadence-plugins/tool call_mypy ../../../hammer-cadence-plugins/par/innovus/__init__.py
fi
if [ -f ../../../hammer-cadence-plugins/power/voltus/__init__.py ]; then
    MYPYPATH=$MYPYPATH:../../../hammer-cadence-plugins/tool call_mypy ../../../hammer-cadence-plugins/power/voltus/__init__.py
fi
