...
def create_hammer_dag_kodiak():
    ...
    return {
        ...
        'Intel4x4ChipTop.build_decider': build_decider,
        'Intel4x4ChipTop.Intel4x4ChipTop.build': build,
        'Intel4x4ChipTop.syn_decider': syn_decider,
        ...
        #ShuttleTile
        'ShuttleTile.syn_decider_shuttle': syn_decider_shuttle,
        'ShuttleTile.syn_shuttle': syn_shuttle,
        'ShuttleTile.par_decider_shuttle': par_decider_shuttle,
        ...
        'ScratchpadBank.par_decider_scratch': par_decider_scratch,
