...
class HammerTool(metaclass=ABCMeta):
    ...
    def get_all_supplies(self, key: str) -> List[Supply]:
        ...
        for raw_supply in supplies:
            ...
            if 'interacts' in raw_supply:
                supply = dataclasses.replace(supply, interacts=raw_supply['interacts'])
    ...
    def get_all_power_domains(self) -> List[PlacementConstraint]:
        ...
        return [
            ...
            if pd.type == PlacementConstraintType.PowerDomain or pd.power_domain is not None
        ]
